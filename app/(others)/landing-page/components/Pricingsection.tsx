                                ...
                                <div>
                                    ...
                                    {plan.tag === "7 Days Free" && (
                                        <div className="flex items-center gap-1 mb-2">
                                            ...
                                            <span className="text-[10px] text-[#F5A623] font-semibold">7 Days Free</span>
                                        </div>
                                    )}
                                    <p
                                    ...
                                    {plan.priceNote && <p className="text-xs mt-1 text-[#9CA3AF] group-hover:text-white/40">{plan.priceNote}</p>}
                                </div>
