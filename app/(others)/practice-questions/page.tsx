...
const QUESTIONS = [
  {
    ...
    options: [
      {
        key: "A" as const,
        text: "Directed towards the wire, magnitude = μ₀qvI / (2πr)",
      },
      {
        key: "B" as const,
        text: "Directed away from the wire, magnitude = μ₀qvI / (2πr)",
      },
      { key: "C" as const, text: "Zero, since the velocity is parallel to B" },
      {
        key: "D" as const,
        text: "Directed perpendicular to both v and r, magnitude = μ₀qvI / (4πr)",
      },
    ],
    correctAnswer: "C",
  },
  ...
  },
  {
    ...
    options: [
      ...
      {
        key: "C" as const,
        text: "The charge-to-mass ratio of the proton and the magnetic field",
      },
